import{c as v,u as F,j as i}from"./index-AJzvrA6K.js";import{B as T}from"./button-DeA3Ng43.js";import{T as Y}from"./textarea-BtEo-Zf4.js";import{w as B,D as j,p as L,l as k,s as X,i as U,f as q,t as H,u as E,a as V,c as W,g as G,d as K}from"./demoStore-BHaQ3lAR.js";import{R as z}from"./rotate-ccw-B_NRIgxo.js";import{S as Q}from"./save-CjJ6ufC-.js";import{c as J}from"./createLucideIcon-CP86rydV.js";import{C as Z}from"./check-ztyatNQY.js";import{C as ee}from"./copy-BoDnr6kj.js";import{C as te}from"./chevron-down-BdBRBH7k.js";const ae=[["path",{d:"M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z",key:"1ffxy3"}],["path",{d:"m21.854 2.147-10.94 10.939",key:"12cjpa"}]],oe=J("send",ae),ne="pwdemo:clinic:doc",ie=1,I="pwdemo:clinic:doc-change";function O(o){return`${ne}:${o}:v${ie}`}function se(o,r){const[h,d]=v.useState(()=>{if(typeof window>"u")return r;try{return localStorage.getItem(O(o))??r}catch{return r}});v.useEffect(()=>{if(typeof window>"u")return;const l=c=>{if(c.detail?.key===o)try{const f=localStorage.getItem(O(o));f!==null&&d(f)}catch{}};return window.addEventListener(I,l),()=>window.removeEventListener(I,l)},[o]);const s=v.useCallback(l=>{d(l);try{localStorage.setItem(O(o),l)}catch{}window.dispatchEvent(new CustomEvent(I,{detail:{key:o}}))},[o]),e=v.useCallback(()=>{d(r);try{localStorage.removeItem(O(o))}catch{}window.dispatchEvent(new CustomEvent(I,{detail:{key:o}}))},[o,r]);return{value:h,set:s,reset:e}}const xe=`# Primewave Mate Clinics — Riyadh
