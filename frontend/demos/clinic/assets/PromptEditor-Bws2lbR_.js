import{c as v,u as X,j as s}from"./index-D3gNPGit.js";import{B as $}from"./button-B6m3L5yw.js";import{T as B}from"./textarea-BT2ipYBT.js";import{w as F,D as O,p as L,l as k,s as Y,i as H,f as U,t as q,u as N,a as W,c as G,g as z,d as K}from"./demoStore-yZesmcet.js";import{R as V}from"./rotate-ccw-DWkPu7Rv.js";import{S as Q}from"./save-BeA7L4Kg.js";import{c as J}from"./createLucideIcon-UONvcWgU.js";import{C as Z}from"./check-DJheph84.js";import{C as ee}from"./copy-DJbLQZJa.js";import{C as te}from"./chevron-down-3vj4UoUb.js";const ae=[["path",{d:"M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z",key:"1ffxy3"}],["path",{d:"m21.854 2.147-10.94 10.939",key:"12cjpa"}]],oe=J("send",ae),ne="pwdemo:clinic:doc",se=1,E="pwdemo:clinic:doc-change";function C(o){return`${ne}:${o}:v${se}`}function ie(o,r){const[h,d]=v.useState(()=>{if(typeof window>"u")return r;try{return localStorage.getItem(C(o))??r}catch{return r}});v.useEffect(()=>{if(typeof window>"u")return;const l=c=>{if(c.detail?.key===o)try{const m=localStorage.getItem(C(o));m!==null&&d(m)}catch{}};return window.addEventListener(E,l),()=>window.removeEventListener(E,l)},[o]);const i=v.useCallback(l=>{d(l);try{localStorage.setItem(C(o),l)}catch{}window.dispatchEvent(new CustomEvent(E,{detail:{key:o}}))},[o]),e=v.useCallback(()=>{d(r);try{localStorage.removeItem(C(o))}catch{}window.dispatchEvent(new CustomEvent(E,{detail:{key:o}}))},[o,r]);return{value:h,set:i,reset:e}}const xe=`# Primewave Mate Clinics — Riyadh
