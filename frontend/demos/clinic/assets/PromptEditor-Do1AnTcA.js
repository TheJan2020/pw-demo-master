import{c as v,u as F,j as i}from"./index-wJtDpWM1.js";import{B as T}from"./button-B5qBv2sr.js";import{T as Y}from"./textarea-DmH5sS5Z.js";import{w as B,D as L,p as j,l as k,s as U,i as q,f as X,t as H,u as N,a as V,c as W,g as K,d as G}from"./demoStore-DMCgTqyD.js";import{R as z}from"./rotate-ccw-CGLUK0X0.js";import{S as Q}from"./save-BRu-m_X3.js";import{c as J}from"./createLucideIcon-BvZvjbvO.js";import{C as Z}from"./check-CiZqBTUC.js";import{C as ee}from"./copy-D7swIluW.js";import{C as te}from"./chevron-down-D8ST6_IA.js";const ae=[["path",{d:"M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z",key:"1ffxy3"}],["path",{d:"m21.854 2.147-10.94 10.939",key:"12cjpa"}]],oe=J("send",ae),ne="pwdemo:clinic:doc",ie=1,I="pwdemo:clinic:doc-change";function R(o){return`${ne}:${o}:v${ie}`}function se(o,r){const[h,d]=v.useState(()=>{if(typeof window>"u")return r;try{return localStorage.getItem(R(o))??r}catch{return r}});v.useEffect(()=>{if(typeof window>"u")return;const l=c=>{if(c.detail?.key===o)try{const f=localStorage.getItem(R(o));f!==null&&d(f)}catch{}};return window.addEventListener(I,l),()=>window.removeEventListener(I,l)},[o]);const s=v.useCallback(l=>{d(l);try{localStorage.setItem(R(o),l)}catch{}window.dispatchEvent(new CustomEvent(I,{detail:{key:o}}))},[o]),e=v.useCallback(()=>{d(r);try{localStorage.removeItem(R(o))}catch{}window.dispatchEvent(new CustomEvent(I,{detail:{key:o}}))},[o,r]);return{value:h,set:s,reset:e}}const xe=`# Primewave Mate Clinics — Riyadh
