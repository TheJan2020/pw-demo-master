import{c as k,u as F,j as i}from"./index-DfHYTpxJ.js";import{B as x}from"./button-CIeIuAY3.js";import{T as Y}from"./textarea-DNJAciTq.js";import{w as U,D as $,p as M,l as w,s as B,i as H,f as W,t as V,u as E,a as q,c as G,g as X,d as K}from"./demoStore-BENV77FA.js";import{R as z}from"./rotate-ccw-D-SsrNIN.js";import{S as Q}from"./save-DZbtMQ7-.js";import{S as J}from"./send-BHAWxBfX.js";import{C as Z}from"./check-peU-vd5U.js";import{C as ee}from"./copy-B4RL6ljZ.js";import{C as te}from"./chevron-down-DvJNlq7p.js";const ae="pwdemo:clinic:doc",oe=1,O="pwdemo:clinic:doc-change";function I(o){return`${ae}:${o}:v${oe}`}function ne(o,r){const[h,d]=k.useState(()=>{if(typeof window>"u")return r;try{return localStorage.getItem(I(o))??r}catch{return r}});k.useEffect(()=>{if(typeof window>"u")return;const l=c=>{if(c.detail?.key===o)try{const u=localStorage.getItem(I(o));u!==null&&d(u)}catch{}};return window.addEventListener(O,l),()=>window.removeEventListener(O,l)},[o]);const s=k.useCallback(l=>{d(l);try{localStorage.setItem(I(o),l)}catch{}window.dispatchEvent(new CustomEvent(O,{detail:{key:o}}))},[o]),e=k.useCallback(()=>{d(r);try{localStorage.removeItem(I(o))}catch{}window.dispatchEvent(new CustomEvent(O,{detail:{key:o}}))},[o,r]);return{value:h,set:s,reset:e}}const we=`# Primewave Mate Clinics — Riyadh
